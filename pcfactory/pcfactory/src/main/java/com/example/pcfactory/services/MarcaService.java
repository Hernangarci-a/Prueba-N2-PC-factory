...
import com.example.pcfactory.dto.MarcaDTO;
import com.example.pcfactory.model.Marca;
import com.example.pcfactory.model.Productos;
import com.example.pcfactory.repository.MarcaRepository;
...
public class MarcaService {
    ...
    public String eliminarMarca(Integer id){
        try{
            Marca marca = marcaRepository.findById(id)
                    .orElseThrow(() -> new RuntimeException("no se puede eliminar la marca con el ID " + id + " no existe."));
