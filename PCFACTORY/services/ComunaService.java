...
import com.example.pcfactory.dto.ComunaDTO;
import com.example.pcfactory.model.Comuna;
import com.example.pcfactory.repository.ComunaRepository;
...
public class ComunaService {
    ...
    public String eliminarComuna(Integer id){
        try{
            Comuna comuna = comunaRepository.findById(id)
                    .orElseThrow(() -> new RuntimeException("no se puede eliminar comuna con ID " + id + " no existe."));
